...
import {
  ...
  ArrowRight, Check, MapPin, DollarSign, Shield, Zap,
} from 'lucide-react';
...
export default function Register() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white p-6">
        <div className="text-center max-w-sm fade-in-up">
          ...
          <p className="text-ink-secondary text-sm mb-2 leading-relaxed">
  ...
  return (
    <div className="min-h-screen flex overflow-hidden">
      ...
      {/* Right Form */}
      <div className="flex-1 flex items-center justify-center bg-white p-6 sm:p-10 relative overflow-hidden overflow-y-auto">
